...
<div class="navbar w-full bg-base-100 shadow-sm">
	<div class="navbar-start gap-2">
		<div class="dropdown">
			...
			>
				<li><a href={resolve('/submit')}>Submission</a></li>
				<!-- <li><a href={resolve("/search")}>Search</a></li> -->
			</ul>
		</div>
		<a href={resolve('/')} class="" aria-label="edal-logo">
			<img src={logo} class="select-none" alt="e!DAL Logo" />
		</a>
	</div>
	<div class="navbar-center">
		<span class="text-lg font-semibold"
			>e!DAL - Plant Genomics & Phenomics Research Data Repository</span
		>
	</div>
		...
		<div class="dropdown dropdown-end">
			...
			>
				{#if accesToken}
					...
					<li>
						<button onclick={logout} class="hover:bg-error hover:text-error-content">Logout</button>
					</li>
				{:else}
...
<div>
	<img
		src={banner}
		alt="Header Banner"
		class="h-8 w-full border-t-4 border-b-4 border-double bg-secondary object-cover select-none"
	/>
</div>
