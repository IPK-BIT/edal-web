...
<div class="card m-4 rounded-lg bg-base-100 p-4 shadow-md">
	<div class="card-body p-0">
		<h3 class="card-title text-lg">
			{$datasetObj.metadata.title || 'No Title Provided'}
			<span class="ml-2 badge badge-primary">{new Date().getFullYear()}</span>
		</h3>
		...
		<div class="text-xs text-neutral-500">
			e!DAL - Plant Genomics and Phenomics Research Data Repository (PGP), IPK Gatersleben; Seeland
